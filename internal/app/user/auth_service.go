...
type AuthService interface {
	...
	SignIn(context.Context, SignInParams) error
}
...
func (s *service) SignIn(ctx context.Context, params SignInParams) error {
	form := validation.NewForm(params)
	...
	hash, err := s.authenticator.SignIn(ctx, params.Email)
